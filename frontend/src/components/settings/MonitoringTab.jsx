...
const MonitoringTab = () => {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-lg border border-border p-6">
      {/* Header */}
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-2 bg-card border border-border rounded-lg text-sm font-medium hover:bg-secondary/80 transition-colors"
          >
            🔃 Refresh
          </button>
        </div>
      ...
      <div className="bg-secondary p-4 rounded-lg border border-border mb-6">
        ...
        <div className="space-y-2">
          {metricsData?.requests?.top_endpoints?.slice(0, 5).map((endpoint, index) => (
            <div key={index} className="flex items-center justify-between text-sm bg-white dark:bg-black p-2 rounded">
              <span className="font-mono text-xs truncate flex-1">{endpoint.endpoint}</span>
              <div className="flex items-center gap-3">
                <span className="text-muted-foreground">{endpoint.count} req</span>
