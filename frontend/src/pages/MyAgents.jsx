          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-6 text-white">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold">${totalBilling}</span>
              </div>
              <p className="text-orange-100 text-sm">Monthly Base</p>
            </div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-4">
                    <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${agent.template?.color || 'from-gray-400 to-gray-500'} flex items-center justify-center text-2xl`}>
                      {agent.template?.icon || '🤖'}
                    </div>
                    <div>
                ...
                <div className="flex items-center space-x-2">
                  {agent.status === 'active' ? (
                    <button
                      ...
                      className="flex-1 flex items-center justify-center px-4 py-2 bg-yellow-50 text-yellow-700 rounded-lg hover:bg-yellow-100 transition-colors text-sm font-medium"
                    >
