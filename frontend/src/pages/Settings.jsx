...
import { CheckCircle2, XCircle, Copy, Trash2, Plus, Eye, EyeOff, Key, HelpCircle } from 'lucide-react';
...
const AVAILABLE_SCOPES = [
  ...
  { value: 'webhooks.write', label: 'Write Webhooks', description: 'Configure webhooks' },
];
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs">
                            <p className="text-sm">Control what this API key can access. Choose 'Full Access' for complete control or select specific permissions for security.</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
